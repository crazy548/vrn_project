...
def train(model_name, gpu_id):
    ...
    generator.load_weights(params['project_dir'] +'/old_models/vgg_100000.h5')
    ...
    for step in xrange(n_iters):
        ...
        if (step+1) % params['model_save_interval'] == 0 and step > 0:
            generator.save(network_dir + '/' + str(step+1) + '.h5')
