...
def get_general_params():
    ...
    param['n_training_iter'] = 100
    param['test_interval'] = 100
    param['model_save_interval'] = 100
    param['project_dir'] = 'C:/Users/sahil/UnseenPoses/posewarp-cvpr2018'
    param['model_save_dir'] = param['project_dir'] + '/models'
    param['data_dir'] = param['project_dir'] + '/dataset'  #The official dataset is to be used
    #param['data_dir'] = param['project_dir'] + '/data/train'
    param['batch_size'] = 4
    return param
